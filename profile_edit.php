...
$phone =$_POST['phone'];
 ...
 if(!(empty($gender)||empty($type)||empty($phone))){
mysqli_query($con,"UPDATE users SET type='$type' , gender='$gender',phoneNumber='$phone' WHERE userId=$id");
...
#inner {
  ...
  <label  style= "margin-right: 20px;">Gender:
    <input  checked type="radio" name="gender" style="margin-left: 20px;" value='Male'>
   Male
  </label>
  <label>
  ...
  <br><hr>
      ...
      <span style="margin: 20px;">Are you a/an</span>
  <select name='type'>
...
<span>Phone number:</span> 
    <input style="margin-left: 20px; width:350px" placeholder="start with your International calling code e.g. 966" name="phone" >     
